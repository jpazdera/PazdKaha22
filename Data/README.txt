...
- data: [WE RECOMMEND USING THESE FILES FOR CONDUCTING YOUR OWN ANALYSES! See also recall_data_expanded.csv]
...
- recall_data.csv:
    ...
    A combined data file generated by ../Analysis/json_to_csv.ipynb and used for our recall analyses in R.
    
- intrusion_data.csv:

    A combined data file generated by ../Analysis/json_to_csv.ipynb and used for our intrusion analyses in R.
    
- recall_data_expanded.csv:

    An expanded version of recall_data.csv that also includes:
        - The ID numbers of the items presented on each list.
        - Whether each presented item was eventually recalled during final free recall.
        - The serial positions of the recalls made on that trial. (see description above of data -> serialpos)